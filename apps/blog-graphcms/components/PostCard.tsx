    ...
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='text-center'>
        <NextLink href={`/post/${post.slug}`} passHref>
          <span className='transition duration-500 ease transform hover:-translate-y-1 
          inline-block bg-pink-600 text-lg font-medium rounded-full text-white px-8 py-3
          cursor-pointer'>
            Continue Reading
          </span>
        </NextLink>
